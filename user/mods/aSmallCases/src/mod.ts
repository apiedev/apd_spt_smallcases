...
import * as itemconfig1 from "../config/itemconfig1.json";
import * as itemconfig2 from "../config/itemconfig2.json";
import * as itemconfig3 from "../config/itemconfig3.json";
import * as itemconfig4 from "../config/itemconfig4.json";
import * as itemconfig5 from "../config/itemconfig5.json";
import * as itemconfig6 from "../config/itemconfig6.json";
import * as itemconfig7 from "../config/itemconfig7.json";
import * as itemconfig8 from "../config/itemconfig8.json";
...
class Mod implements IPostAkiLoadMod, IPostDBLoadMod 
{
    ...
    public postDBLoad(container: DependencyContainer): void 
    {
        ...
        const customItemConfigs = [
            ...
            // Add other custom item configurations as needed
        ];

        // Iterate over the custom item configurations and add the items dynamically
        customItemConfigs.forEach((config) => 
        {
            ...
            for (const i in tables.templates.items) 
            {
                ...
                {
                    if (!tables.templates.items[i]._props.Grids[0]._props.filters) 
                    {
                        // Initialize filters with compatFiltersElement if it doesn't exist
