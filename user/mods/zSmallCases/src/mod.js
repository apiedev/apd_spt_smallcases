...
const itemconfig1 = __importStar(require("../config/itemconfig1.json"));
const itemconfig2 = __importStar(require("../config/itemconfig2.json"));
const itemconfig3 = __importStar(require("../config/itemconfig3.json"));
const itemconfig4 = __importStar(require("../config/itemconfig4.json"));
const itemconfig5 = __importStar(require("../config/itemconfig5.json"));
const itemconfig6 = __importStar(require("../config/itemconfig6.json"));
const itemconfig7 = __importStar(require("../config/itemconfig7.json"));
class Mod {
    constructor() {
